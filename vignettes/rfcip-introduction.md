...
head(current_data)
#> # A tibble: 6 × 21
#>   commodity_year policies_sold policies_earning_prem
#>            <dbl>         <dbl>                 <dbl>
#> 1           2025            60                    28
#> 2           2025           795                   365
#> 3           2025            82                    79
...
#> 5           2025            16                    14
#> 6           2025          7669                  6982
#> # ℹ 18 more variables: policies_indemnified <dbl>,
#> #   units_earning_prem <dbl>, units_indemnified <dbl>,
#> #   quantity <dbl>, quantity_type <chr>,
#> #   companion_endorsed_acres <dbl>, liabilities <dbl>,
#> #   total_prem <dbl>, subsidy <dbl>, indemnity <dbl>,
#> #   efa_prem_discount <dbl>, addnl_subsidy <dbl>,
...
head(multi_data)
#> # A tibble: 6 × 25
#>   commodity_year commodity_code commodity_name state_code
#>            <dbl>          <int> <chr>               <dbl>
#> 1           2020             41 Corn                   19
#> 2           2020             81 Soybeans               19
#> 3           2021             41 Corn                   19
#> 4           2021             81 Soybeans               19
#> 5           2022             41 Corn                   19
#> 6           2022             81 Soybeans               19
#> # ℹ 21 more variables: state_abbrv <chr>, policies_sold <dbl>,
...
head(plans)
#> # A tibble: 6 × 4
#>   commodity_year insurance_plan_code insurance_plan                 
#>   <chr>          <chr>               <chr>                          
#> 1 2024           90                  APH                            
#> 2 2024           91                  APH Price Component            
#> 3 2024           43                  Aquaculture Dollar             
#> 4 2024           47                  Actual Revenue History         
#> 5 2024           05                  Area Revenue Protection        
#> 6 2024           06                  Area Revenue Protection - Harv…
#> # ℹ 1 more variable: insurance_plan_abbrv <chr>
...
head(price_data)
#> # A tibble: 6 × 38
#>   CommodityYear CommodityCode CommodityName TypeCode TypeName       
#>           <int>         <int> <chr>            <int> <chr>          
#> 1          2022            41 Corn                16 High Amylose   
#> 2          2022            41 Corn                16 High Amylose   
#> 3          2022            41 Corn                17 All (Non-High …
#> 4          2022            41 Corn                17 All (Non-High …
#> 5          2023            41 Corn                16 High Amylose   
#> 6          2023            41 Corn                16 High Amylose   
#> # ℹ 33 more variables: PracticeCode <int>, PracticeName <chr>,
#> #   StateCode <int>, StateName <chr>,
#> #   PriceMultiplicativeFactor <dbl>, PriceAdditiveFactor <dbl>,
#> #   ProjectedPriceExchangeCode <chr>,
#> #   ProjectedPriceMarketSymbolCode <chr>,
...
#>   <chr>               <dbl> <chr>            <chr>             <dbl>
#> 1 AR                   1998 NationalFund     gross_liability  3.29e9
#> 2 AR                   1998 NationalFund     gross_premium    3.14e8
#> 3 AR                   1998 NationalFund     gross_indemnity  4.63e8
#> 4 AR                   1998 NationalFund     retained_liabi…  5.97e8
#> 5 AR                   1998 NationalFund     retained_premi…  5.85e7
#> 6 AR                   1998 NationalFund     retained_indem…  5.18e7
#> # ℹ 6 more variables: data_release_month <dbl>,
#> #   data_release_year <dbl>, data_release_day <dbl>,
#> #   data_release_date <date>, fund_name <chr>, report_type <chr>
