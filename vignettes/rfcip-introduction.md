...
head(col_data)
#>   commodity_year state_code state_abbrv county_code county_name commodity_code commodity_name insurance_plan_code
#> 1           2020          1          AL           1     Autauga             21         Cotton                   2
#> 2           2020          1          AL           1     Autauga             21         Cotton                   2
#> 3           2020          1          AL           1     Autauga             21         Cotton                   2
#> 4           2020          1          AL           1     Autauga             41           Corn                   2
#> 5           2020          1          AL           1     Autauga             41           Corn                   2
#> 6           2020          1          AL           1     Autauga             41           Corn                   2
#>   insurance_plan_abbrv delivery_type stage_code col_code                           col_name month_of_loss_code
#> 1                   RP             A          H       31 Excess Moisture/Precipitation/Rain                  9
#> 2                   RP             A          H       92      Hurricane/Tropical Depression                 10
#> 3                   RP             A          H       92      Hurricane/Tropical Depression                  9
#> 4                   RP             A          H        1                   Decline in Price                  9
#> 5                   RP             A          H       11                            Drought                  7
#> 6                   RP             A          R       93                           Wildlife                  5
#>   month_of_loss_name year_of_loss policies_earning_prem policies_indemnified net_planted_qty net_endorsed_acres  liability
#> 1                SEP         2020                     1                    1          38.925                  0  11519.000
#> 2                OCT         2020                     3                    3         992.425                  0 495420.000
#> 3                SEP         2020                     3                    3         392.600                  0 220061.000
#> 4                SEP         2020                     1                    1          12.900                  0   2543.665
#> 5                JUL         2020                     1                    1           8.100                  0   1597.185
#> 6                MAY         2020                     1                    1          30.000                  0   5915.500
#>   total_premium producer_paid_premium  subsidy state_subsidy addnl_subsidy efa_prem_discount indemnified_quantity indem_amount
#> 1      1389.000               570.000   819.00             0             0                 0               38.925      1938.00
#> 2     38585.500              8457.500 30128.00             0             0                 0              992.425     95015.00
#> 3     17815.500              4157.500 13658.00             0             0                 0              392.600     18962.00
#> 4       437.095               196.725   240.37             0             0                 0               25.800      1602.18
#> 5       274.455               123.525   150.93             0             0                 0               16.200      1006.02
#> 6      1016.500               457.500   559.00             0             0                 0               14.000       439.00
#>   loss_ratio
#> 1       1.40
#> 2       2.46
#> 3       1.06
...
#> 1          2020            41 Corn                16 High Amylose                      2 Conventional        17 Illinois 
#> 2          2020            41 Corn                16 High Amylose                      3 Organic             17 Illinois 
#> 3          2020            41 Corn                17 All (Non-High Amylose)            2 Conventional        17 Illinois 
#> 4          2020            41 Corn                17 All (Non-High Amylose)            3 Organic             17 Illinois 
#> 5          2021            41 Corn                16 High Amylose                      2 Conventional        17 Illinois 
#> 6          2021            41 Corn                16 High Amylose                      3 Organic             17 Illinois 
#> # ℹ 29 more variables: PriceMultiplicativeFactor <dbl>, PriceAdditiveFactor <dbl>, ProjectedPriceExchangeCode <chr>,
#> #   ProjectedPriceMarketSymbolCode <chr>, ProjectedPricePreviousMarketSymbolCode <chr>,
#> #   ProjectedPriceCurrencyMarketSymbolCode <lgl>, ProjectedPriceBeginDate <dttm>, ProjectedPriceEndDate <dttm>,
#> #   ProjectedPriceDateRange <chr>, ProjectedPrice <dbl>, ApprovedPriceVolatilityPercent <dbl>, HarvestPriceExchangeCode <chr>,
#> #   HarvestPriceMarketSymbolCode <chr>, HarvestPriceCurrencyMarketSymbolCode <lgl>, HarvestPriceBeginDate <dttm>,
#> #   HarvestPriceEndDate <dttm>, HarvestPriceDateRange <chr>, HarvestPrice <dbl>, HarvestPriceStatus <chr>,
#> #   ProjectedSymbolCode <chr>, ProjectedSymbolName <chr>, ProjectedMonthCode <chr>, ProjectedMonthName <chr>, …
```
...
head(nationalSRA)
#> # A tibble: 6 × 11
#>   fund_abb reinsurance_year report_geography value_type           dollars data_release_month data_release_year data_release_day
#>   <chr>               <dbl> <chr>            <chr>                  <dbl>              <dbl>             <dbl>            <dbl>
#> 1 AR                   1998 NationalFund     gross_liability       3.29e9                  2              2002                9
#> 2 AR                   1998 NationalFund     gross_premium         3.14e8                  2              2002                9
#> 3 AR                   1998 NationalFund     gross_indemnity       4.63e8                  2              2002                9
#> 4 AR                   1998 NationalFund     retained_liability    5.97e8                  2              2002                9
#> 5 AR                   1998 NationalFund     retained_premium      5.85e7                  2              2002                9
#> 6 AR                   1998 NationalFund     retained_indemnity    5.18e7                  2              2002                9
#> # ℹ 3 more variables: data_release_date <date>, fund_name <chr>, report_type <chr>
...
head(stateSRA)
#> # A tibble: 6 × 12
#>   state fund_abb reinsurance_year report_geography value_type     dollars data_release_month data_release_year data_release_day
#>   <chr> <chr>               <int> <chr>            <chr>            <dbl>              <dbl>             <dbl>            <dbl>
#> 1 AL    AR                   1998 StateFund        gross_liabili…  6.35e7                  2              2002                9
#> 2 AL    AR                   1998 StateFund        gross_premium   7.15e6                  2              2002                9
#> 3 AL    AR                   1998 StateFund        gross_indemni…  1.64e7                  2              2002                9
#> 4 AL    AR                   1998 StateFund        retained_liab…  1.27e7                  2              2002                9
#> 5 AL    AR                   1998 StateFund        retained_prem…  1.43e6                  2              2002                9
#> 6 AL    AR                   1998 StateFund        retained_inde…  1.51e6                  2              2002                9
#> # ℹ 3 more variables: data_release_date <date>, fund_name <chr>, report_type <chr>
...
head(nationalLPRA)
#> # A tibble: 6 × 10
#>   reinsurance_year report_geography footnote           value_type dollars data_release_month data_release_year data_release_day
#>              <dbl> <chr>            <chr>              <chr>        <dbl>              <dbl>             <dbl>            <dbl>
#> 1             2014 NationalFund     "Footnote: Amount… gross_lia…  1.04e9                 10              2018                1
#> 2             2014 NationalFund     "Footnote: Amount… gross_pre…  2.28e7                 10              2018                1
#> 3             2014 NationalFund     "Footnote: Amount… gross_ind…  1.05e7                 10              2018                1
#> 4             2014 NationalFund     "Footnote: Amount… retained_…  4.03e8                 10              2018                1
#> 5             2014 NationalFund     "Footnote: Amount… retained_…  8.64e6                 10              2018                1
#> 6             2014 NationalFund     "Footnote: Amount… retained_…  3.69e6                 10              2018                1
#> # ℹ 2 more variables: data_release_date <date>, report_type <chr>
...
## Livestock Actuarial Data Master (ADM)

RMA's [Livestock ADM](https://pubfs-rma.fpac.usda.gov/pub/References/adm_livestock/) contains the actuarial reference data used for livestock insurance programs, including Dairy Revenue Protection (DRP), Livestock Risk Protection (LRP), and Livestock Gross Margin (LGM). The `get_livestock_adm_data()` function provides access to these datasets for years 2014-2026.

### Available Datasets

- **lrp** (default): Livestock Risk Protection actual ending values (daily, 2014+)
- **lgm**: Livestock Gross Margin data (daily, 2014+)
- **drp_daily_price**: DRP expected commodity prices (daily, 2019+)
- **drp_draw**: DRP draw data (quarterly, 2019+)
- **drp_milk_yield**: DRP state-level milk yield data (quarterly, 2019+)
- **drp_actual_price**: DRP settled/actual prices (quarterly, 2019+)
- **drp_fmmo_pricing**: DRP FMMO pricing factors (yearly, 2019+)

### Basic Usage


``` r
# Get the latest LRP data for 2025
lrp_2025 <- get_livestock_adm_data(year = 2025, dataset = "lrp")

# Get LGM data for multiple years
lgm_data <- get_livestock_adm_data(year = 2020:2025, dataset = "lgm")

# Get DRP FMMO pricing factors
...
For daily datasets (LRP, LGM, DRP daily price), each file on the server represents a snapshot for a specific date. The `date` parameter controls which file(s) to download:

- **`"latest"`** (default): Download only the most recent file for each year.
- **`NULL`**: Download all files for the year and combine them into a full time series. This can involve many files and may take a while.
- **A specific date string**: Download the file with the closest date on or before the specified date.


``` r
# Get only the latest LRP snapshot for 2025 (default)
lrp_latest <- get_livestock_adm_data(year = 2025, dataset = "lrp")

# Get the full daily time series for 2024
lrp_all_2024 <- get_livestock_adm_data(year = 2024, dataset = "lrp", date = "all")
...
head(ice_meta_2024)
#>   year                                    filename                description size_bytes size_mb       date     time
#> 1 2024                        2024_D00001_CCWS.txt                   Ccws.txt     383571    0.37 03/16/2026 05:31 AM
#> 2 2024                        2024_D00001_PASS.txt                   Pass.txt     866817    0.83 03/16/2026 05:31 AM
#> 3 2024                         2024_D00001_ROE.txt                    Roe.txt      91508    0.09 03/16/2026 05:31 AM
#> 4 2024           2024_D00002_ProcessResult_YTD.txt             Process Result        472    0.00 07/31/2023 06:05 AM
#> 5 2024 2024_D00003_IceAddedCountyIndicator_YTD.txt Ice Added County Indicator        399    0.00 07/31/2023 06:05 AM
#> 6 2024     2024_D00004_IceRelationshipType_YTD.txt      Ice Relationship Type        569    0.00 07/31/2023 06:05 AM
#>              datetime
#> 1 2026-03-16 05:31:00
#> 2 2026-03-16 05:31:00
#> 3 2026-03-16 05:31:00
#> 4 2023-07-31 06:05:00
#> 5 2023-07-31 06:05:00
#> 6 2023-07-31 06:05:00
#>                                                                                                                               url
...
head(legal_data)
#> # A tibble: 6 × 9
#>   record_type_code state_code county_code legal_description township_range frst_divid          released_date last_released_date
#>   <chr>            <chr>      <chr>       <chr>             <chr>          <chr>               <date>        <date>            
#> 1 D00062           01         001         0001-015N-012E    015N-012E      AL250150N0120E0SN0… 2026-03-13    2026-01-25        
#> 2 D00062           01         001         0001-016N-012E    016N-012E      AL250160N0120E0SN0… 2026-03-13    2026-01-25        
#> 3 D00062           01         001         0001-016N-013E    016N-013E      AL250160N0130E0SN0… 2026-03-13    2026-01-25        
#> 4 D00062           01         001         0001-016N-014E    016N-014E      AL250160N0140E0SN0… 2026-03-13    2026-01-25        
#> 5 D00062           01         001         0001-016N-015E    016N-015E      AL250160N0150E0SN0… 2026-03-13    2026-01-25        
#> 6 D00062           01         001         0001-017N-012E    017N-012E      AL250170N0120E0SN0… 2026-03-13    2026-01-25        
#> # ℹ 1 more variable: deleted_date <lgl>
```
